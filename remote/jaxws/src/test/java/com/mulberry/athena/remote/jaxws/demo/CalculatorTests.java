...
import com.mulberry.athena.remote.jaxws.HttpServerWsPublisher;
import com.mulberry.athena.remote.jaxws.JaxWsClient;
import com.mulberry.athena.remote.jaxws.JaxWsServicePublisher;
import com.mulberry.athena.remote.jaxws.JaxWsUtils;
import com.mulberry.athena.toolkit.xml.XMLs;
...
public class CalculatorTests {
    ...
    public static void start() throws Exception {
        publisher.setPackages(ImmutableSet.of("com.mulberry.athena.remote.jaxws"));
        publisher.start();
        publisher.publish();
