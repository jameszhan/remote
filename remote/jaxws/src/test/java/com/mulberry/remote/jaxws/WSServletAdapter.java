 ...
 * (2) WSServletDelegate - implements logic, which binds HTTP transport with WS endpoints
 * (3) WSServletContextListener - Servlet context listener, which is responsible for
 * parsing WS deployment descriptor and generation WS adapters, which represent WS.
 *
 * @author James.Zhan
 */
/*
