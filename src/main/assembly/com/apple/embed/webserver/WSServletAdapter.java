...
public class WSServletAdapter extends ServletAdapter {
	...
	public WSServletAdapter(String publicDirectory, ServletContextImpl servletCtx, HashMap<String, String> contextParameters, HashMap<String, String> servletInitParameters,
			ArrayList<String> listeners, boolean initialize) {
		super(publicDirectory, servletCtx, contextParameters, servletInitParameters, listeners, initialize);

	}

	public WSServletAdapter(String publicDirectory, ServletContextImpl servletCtx, HashMap<String, String> contextParameters, HashMap<String, String> servletInitParameters,
			ArrayList<String> listeners) {
		super(publicDirectory, servletCtx, contextParameters, servletInitParameters, listeners);
	}

	public WSServletAdapter(String publicDirectory, ServletContextImpl servletCtx, HashMap<String, String> contextParameters, HashMap<String, String> servletInitParameters,
			boolean initialize) {
		super(publicDirectory, servletCtx, contextParameters, servletInitParameters, initialize);
	}
